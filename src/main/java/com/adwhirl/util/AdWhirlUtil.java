...
*/
	...
	public static final String urlConfig = "http://ads.mymalcom.com/getInfo.php?appid=%s&appver=%d&client=2";
	public static final String urlImpression = "http://ads.mymalcom.com/exmet.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlClick = "http://ads.mymalcom.com/exclick.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlCustom = "http://ads.mymalcom.com/custom.php?appid=%s&nid=%s&uuid=%s&country_code=%s%s&appver=%d&client=2";
